...
const ATTEMPT_STATES = Object.freeze(['pending','started','in_progress','paused','disconnected','reconnected','finished','incomplete','restarted','deleted']);
...
const ATTEMPT_TRANSITIONS = Object.freeze({
  ...
  finished:['restarted','deleted'], incomplete:['restarted','deleted'], restarted:[], deleted:[],
});
